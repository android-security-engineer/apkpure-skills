...
var DEFAULT_DOWNLOAD_DIR = join2(homedir(), ".apkpure", "downloads");
var DEFAULT_CONFIG = {
  mode: "auto",
  locale: "en-US",
  timeout: 3e4,
...
import { mkdirSync as mkdirSync2, renameSync, statSync } from "fs";
...
async function downloadApk(url, packageName, version, fileType, options, proxy = "") {
  ...
  const filePath = join3(options.outputDir, fileName);
...
var CLASH_CONFIG_PATHS = [
  ...
  join4(homedir2(), ".config/clash-verge"),
  join4(homedir2(), ".config/clash"),
  join4(homedir2(), ".config/mihomo")
];
